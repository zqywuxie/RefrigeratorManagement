      ...
      <ResponsiveDialogContent className="max-w-lg">
        <form onSubmit={handleSubmit} className="flex flex-col max-h-[85vh]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="患者姓名"
                className="w-full px-3 py-2 rounded-lg text-[16px] sm:text-[14px] min-h-[44px] outline-none"
                style={fieldStyle}
                required
              />
            </div>
          ...
          <textarea
            ...
            placeholder="备注（选填）"
            rows={2}
            className="w-full px-3 py-2 rounded-lg text-[16px] sm:text-[14px] min-h-[44px] outline-none resize-none"
            style={fieldStyle}
          />
              ...
              {onAddTubes && (
                <div className="flex items-center gap-2 mt-2">
                  <input
                    ...
                    placeholder="添加格位编号"
                    className="flex-1 px-3 py-1.5 rounded-lg text-[13px] min-h-[44px] outline-none"
                    style={fieldStyle}
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-[13px] min-h-[44px] flex items-center gap-1"
              ...
              {newPositions.length > 0 && (
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-[12px] min-h-[44px]"
